...
plt.plot(line_X, line_Y_sgd, c='r', label="SGD")
plt.plot(line_X, line_Y_svr, c='g', label="SVR")
plt.legend()
plt.show()
...
plt.scatter(Y_test, Y_pred_sgd-Y_test, c='r', marker='s', label="SGD")

plt.scatter(Y_test, Y_pred_svr-Y_test, c='g', marker='s', label="SVR")
plt.legend()
